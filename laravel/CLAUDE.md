...
Issues live in GitHub Issues on `github.com/Andeveling/wacrm`. See `docs/agents/issue-tracker.md`.
...
Single-context layout — one `CONTEXT.md` + `docs/adr/`. See `docs/agents/domain.md`.
